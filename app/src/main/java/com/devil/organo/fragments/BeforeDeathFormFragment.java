...
public class BeforeDeathFormFragment extends android.app.Fragment{
    View rootView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_before_death_form, container, false);
    ...
    public void submit(){
        ...
        if(((CheckBox)rootView.findViewById(R.id.blood)).isChecked()) organs[0]=1; else organs[0] = 0;
        if(((CheckBox)rootView.findViewById(R.id.boneMarrow)).isChecked()) organs[1]=1; else organs[1] = 0;
        if(((CheckBox)rootView.findViewById(R.id.kidney)).isChecked()) organs[2]=1; else organs[2] = 0;
    ...
    private void send() {
        ...
        DatabaseReference myRef = database.getReference("form/BD");
        ...
        myRef.child("blood").push().setValue(organs[0]);
        myRef.child("boneMarrow").push().setValue(organs[1]);
        myRef.child("kidney").push().setValue(organs[2]);
